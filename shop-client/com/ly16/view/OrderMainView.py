...
from com.ly16.service.order_service import add_order, select_new_order, select_order, remove_order, \
    modify_order_stat
...
def show_order_main_view(pros, users, orders, sign):
    ...
    if order_oper == "1":
        ...
        if not sadd:
            ...
            order = Order(order.order_id, order.user_id, order.pro_id, order.buy_num, order.address, order.order_stat,order.order_time)
