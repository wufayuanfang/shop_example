...
from com.ly16.service.product_service import add_product, remove_product, update_product, select_product, \
    select_new_pro
...
def showProMgrView(pros, users, orders, sign):
    ...
    if pro_oper == "1":
        ...
        if not sadd:
            ...
            pro = select_new_pro()  # 向服务器查询刚添加的数据
            pros.append(pro)
    elif pro_oper == "2":
        print("商品下架")
        ...
        sdel = remove_product(pro_id)  # 下架商品
